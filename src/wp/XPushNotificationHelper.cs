...
namespace WPCordovaClassLib.Cordova.Commands
{
    public class XPushNotificationHelper
    {
        ...
        public static event EventHandler<string> OnPushChannelUriUpdated;

        private static XPushNotificationHelper instance;

        public static XPushNotificationHelper GetInstance()
        {
            if (null == instance)
            {
                instance = new XPushNotificationHelper();
            }
            return instance;
        }
        ...
        void PushChannel_ChannelUriUpdated(object sender, NotificationChannelUriEventArgs e)
        {
            ...
            if (OnPushChannelUriUpdated != null)
            {
                OnPushChannelUriUpdated(null, e.ChannelUri.ToString());
            }
